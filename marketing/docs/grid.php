  		...
  		<section role="main">
  		  <div class="row">
  		    <div class="eight columns">
      			<h3>The Grid</h3>
      			<h4 class="subheader">Foundation 3's grid is a 12-column, nestable construct to help you quickly create most any layout. Using media queries the grid also adapts itself to small devices, so you can build single pages with layouts appropriate to the device constraints your user brings to the table.</h4>
